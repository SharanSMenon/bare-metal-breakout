 ...
 * @brief Circle doesn't allow to draw text anywhere on the screen.
 * @version 0.1
 * @date 2022-06-22
 * 
 * @copyright Copyright (c) 2022
 * 
 * Borrowed from the following repo:
 * https://github.com/isometimes/rpi4-osdev/blob/master/part6-breakout/terminal.h
 */

#ifndef _screenfont_h
#define _screenfont_h
